...
#ifdef OPLUS_FEATURE_WIFI_POWER
struct COUNTRY_POWER_LIMIT_TABLE_DEFAULT_INFO
  	g_rlmPowerLimitDefaultTable_24749[PWR_LIMIT_DEFAULT_BASE_NUM] = {
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_24749),
  #if (CFG_SUPPORT_WIFI_6G_PWR_MODE == 1)
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_VLP_24749),
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_SP_24749)
  #endif /* CFG_SUPPORT_WIFI_6G_PWR_MODE == 1*/
  };

struct COUNTRY_POWER_LIMIT_TABLE_DEFAULT_INFO
  	g_rlmPowerLimitDefaultTable_24622[PWR_LIMIT_DEFAULT_BASE_NUM] = {
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_24622),
  #if (CFG_SUPPORT_WIFI_6G_PWR_MODE == 1)
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_VLP_24622),
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_SP_24622)
  #endif /* CFG_SUPPORT_WIFI_6G_PWR_MODE == 1*/
  };
  
struct COUNTRY_POWER_LIMIT_TABLE_DEFAULT_INFO
  	g_rlmPowerLimitDefaultTable_24825[PWR_LIMIT_DEFAULT_BASE_NUM] = {
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_24825),
  #if (CFG_SUPPORT_WIFI_6G_PWR_MODE == 1)
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_VLP_24825),
  		PWR_LMT_TBL_REG(g_rRlmPowerLimitDefault_SP_24825)
  #endif /* CFG_SUPPORT_WIFI_6G_PWR_MODE == 1*/
  };

struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION_INFO
    g_rlmPowerLimitConfigTable_24749[PWR_LIMIT_CONFIG_BASE_NUM] = {
    {
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationLegacy_24749),
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationHE_24749),
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationEHT_24749),
    },
};

struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION_INFO
    g_rlmPowerLimitConfigTable_24622[PWR_LIMIT_CONFIG_BASE_NUM] = {
    {
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationLegacy_24622),
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationHE_24622),
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationEHT_24622),
    },
};

struct COUNTRY_POWER_LIMIT_TABLE_CONFIGURATION_INFO
    g_rlmPowerLimitConfigTable_24825[PWR_LIMIT_CONFIG_BASE_NUM] = {
    {
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationLegacy_24825),
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationHE_24825),
        PWR_LMT_TBL_REG(g_rRlmPowerLimitConfigurationEHT_24825),
    },
};
...
struct oplus_country_pwr_limit_default_emi g_oplusCountryPwrLimitDefaultEmi[] = {
      {24749, g_rlmPowerLimitDefaultTable_24749},
      {24825, g_rlmPowerLimitDefaultTable_24825},
      {24622, g_rlmPowerLimitDefaultTable_24622},
  };

struct oplus_country_pwr_limit_configuration_emi g_oplusCountryPwrLimitConfigurationEmi[] = {
      {24749, g_rlmPowerLimitConfigTable_24749},
      {24825, g_rlmPowerLimitConfigTable_24825},
      {24622, g_rlmPowerLimitConfigTable_24622},
  };
#endif /*OPLUS_FEATURE_WIFI_POWER*/
