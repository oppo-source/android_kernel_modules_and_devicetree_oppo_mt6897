...
#define PFX "CAM_CAL_CRUISERHFRONT"
...
#define READ_4000K 0
#define USE_AF 0
#define DEBUG_CALIBRATION_LOAD 0

static unsigned int do_single_lsc_cruiserhfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_cruiserhfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_cruiserhfront(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);

static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x01C40055, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		{0x00000001, 0x00000000, 0x0000000A, do_module_version},
		{0x00000001, 0x00000000, 0x00000002, do_part_number},
		{0x00000001, 0x00000B00, 0x0000074C, do_single_lsc_cruiserhfront},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_cruiserhfront},  //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_cruiserhfront}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT cruiserhfront_op_eeprom = {
	.name = "cruiserhfront_op_eeprom",
