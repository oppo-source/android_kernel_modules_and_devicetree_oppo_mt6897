...
#define PFX "CAM_CAL_CAYMANPUWIDE"
...
static unsigned int do_single_lsc_caymanpuwide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_caymanpuwide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_caymanpuwide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int layout_check_caymanpuwide(struct EEPROM_DRV_FD_DATA *pdata, unsigned int sensorID);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0065009A, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000530, 0x0000074C, do_single_lsc_caymanpuwide},
		{0x00000001, 0x00000020, 0x00000010, do_2a_gain_caymanpuwide},  //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_caymanpuwide}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT caymanpuwide_op_eeprom = {
	.name = "caymanpuwide_op_eeprom",
	.check_layout_function = layout_check_caymanpuwide,
...
static struct STRUCT_CAM_CAL_CONFIG_STRUCT *cam_cal_config = &caymanpuwide_op_eeprom;
static unsigned int do_single_lsc_caymanpuwide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData)
{
