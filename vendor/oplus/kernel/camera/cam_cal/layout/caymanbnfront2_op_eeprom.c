...
#define PFX "CAM_CAL_CAYMANBNFRONT2"
...
static unsigned int do_single_lsc_caymanbnfront2(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_caymanbnfront2(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_caymanbnfront2(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
    0x00000006, 0x01510008, CAM_CAL_SINGLE_EEPROM_DATA,
    {
        ...
        {0x00000001, 0x00000600, 0x0000074C, do_single_lsc_caymanbnfront2},
        {0x00000001, 0x00000020, 0x0000000E, do_2a_gain_caymanbnfront2},  //Start address, block size is useless
        {0x00000000, 0x00000FAE, 0x00000550, do_stereo_data},
        {0x00000001, 0x00000000, 0x00002000, do_dump_all},
        {0x00000001, 0x00000008, 0x00000002, do_lens_id_caymanbnfront2}
    }
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT caymanbnfront2_op_eeprom = {
	.name = "caymanbnfront2_op_eeprom",
