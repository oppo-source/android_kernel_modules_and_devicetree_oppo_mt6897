...
#define PFX "CAM_CAL_CAYMANBNMAIN"
...
static unsigned int do_single_lsc_caymanbnmain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_caymanbnmain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_caymanbnmain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_pdaf_caymanbnmain(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x0148012E, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00001070, 0x0000074C, do_single_lsc_caymanbnmain},
		{0x00000001, 0x00000007, 0x0000000E, do_2a_gain_caymanbnmain}, //Start address, block size is useless
		{0x00000001, 0x000017D0, 0x0000102E, do_pdaf_caymanbnmain},
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_caymanbnmain}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT caymanbnmain_op_eeprom = {
	.name = "caymanbnmain_op_eeprom",
