...
#define PFX "CAM_CAL_ZHUQUES2WIDE"
...
static unsigned int do_single_lsc_zhuques2wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_2a_gain_zhuques2wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
static unsigned int do_lens_id_zhuques2wide(struct EEPROM_DRV_FD_DATA *pdata,
		unsigned int start_addr, unsigned int block_size, unsigned int *pGetSensorCalData);
...
static struct STRUCT_CALIBRATION_LAYOUT_STRUCT cal_layout_table = {
	0x00000006, 0x016f009c, CAM_CAL_SINGLE_EEPROM_DATA,
	{
		...
		{0x00000001, 0x00000B00, 0x0000074C, do_single_lsc_zhuques2wide},
		{0x00000001, 0x00000020, 0x0000000E, do_2a_gain_zhuques2wide},  //Start address, block size is useless
		...
		{0x00000001, 0x00000008, 0x00000002, do_lens_id_zhuques2wide}
	}
};

struct STRUCT_CAM_CAL_CONFIG_STRUCT zhuques2wide_op_eeprom = {
	.name = "zhuques2wide_op_eeprom",
	.check_layout_function = layout_check,
	.read_function = Common_read_region,
	.layout = &cal_layout_table,
	.sensor_id = ZHUQUES2WIDE_SENSOR_ID,
	.i2c_write_id = 0xA2,
	.max_size = 0x4000,
	.enable_preload = 1,
	.preload_size = 0x4000,
