                 ...
                 const struct i2c_device_id *id)
{
    ...
    struct pinctrl_state *i2c_pinmux;
    int access_time = 3;
    ...
    if (IS_ERR(pinctrl)) {
        ...
        i2c_pinmux = pinctrl_lookup_state(pinctrl, "i2c_state");
        if (IS_ERR(i2c_pinmux)) {
            ret = PTR_ERR(i2c_pinmux);
            dev_err(&i2c->dev, "Cannot find pinctrl i2c_pinmux!\n");
        } else {
            pinctrl_select_state(pinctrl, i2c_pinmux);
        }
    }
