...
#include "ac264_p_3_a0004_dsi_cmd_panel.h"
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	DISP_ERR("ac264_p_3_a0004 %s +, mode id=%d\n", __func__, mode_id);
	//panel_power_on = true;
	switch (mode_id) {
	case FHD_SDC60:
	...
	DISP_ERR("%s,ac264_p_3_a0004 restore seed_mode:%d\n", __func__, temp_seed_mode);
...
//	.corner_pattern_lt_addr = (void *)top_rc_pattern,
		...
		.dsc_params = {
			...
			.ext_pps_cfg = {
				.enable = 1,
				.rc_buf_thresh = ili7838e_buf_thresh,
				.range_min_qp = ili7838e_range_min_qp,
				.range_max_qp = ili7838e_range_max_qp,
				.range_bpg_ofs = ili7838e_range_bpg_ofs,
			},
		},
...
static int lcm_setbacklight_cmdq(void *dsi, dcs_write_gce cb, void *handle, unsigned int level)
{
	...
	DISP_ERR("ac264_p_3_a0004 backlight = %d bl_level[1]=%x, bl_level[2]=%x\n", level, bl_level[1], bl_level[2]);
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: ac264_p_3_a0004 poweron Start\n", __func__);
	//iovcc enable 1.8V
	...
	DISP_ERR("%s: ac264_p_3_a0004 poweron Successful\n", __func__);
	return 0;
}
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: ac264_p_3_a0004 poweroff Start\n", __func__);
	...
	if (ret < 0)
		lcm_unprepare(panel);
	DISP_ERR("%s: ac264_p_3_a0004 poweroff Successful\n", __func__);
	return 0;
}
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	pr_err("[LCM] %s+ ac264_p_3_a0004 Start\n", __func__);
	...
	register_device_proc("lcd", "AC264_A0004", "P_3");
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	pr_err("ac264_p_3_a0004 lcm probe End.\n");
	return ret;
}
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "ac264,p,3,a0004,cmd",
	},
	{}
};
...
MODULE_AUTHOR("oplus");
MODULE_DESCRIPTION("ac264,p,3,a0004,cmd,OLED Driver");
