...
#include "ac264_p_7_a0014_dsi_cmd_panel.h"
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	DISP_ERR("ac264_p_7_a0014 %s +, mode id=%d\n", __func__, mode_id);
	//panel_power_on = true;
	switch (mode_id) {
	case FHD_SDC60:
	...
	DISP_ERR("%s,ac264_p_7_a0014 restore seed_mode:%d\n", __func__, temp_seed_mode);
...
static int lcm_setbacklight_cmdq(void *dsi, dcs_write_gce cb, void *handle, unsigned int level)
{
	...
	DISP_ERR("ac264_p_7_a0014 backlight = %d bl_level[1]=%x, bl_level[2]=%x\n", level, bl_level[1], bl_level[2]);
...
static int lcm_panel_poweron(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: ac264_p_7_a0014 poweron Start\n", __func__);
	//iovcc enable 1.8V
	...
	DISP_ERR("%s: ac264_p_7_a0014 poweron Successful\n", __func__);
	return 0;
}
...
static int lcm_panel_poweroff(struct drm_panel *panel)
{
	...
	DISP_ERR("%s: ac264_p_7_a0014 poweroff Start\n", __func__);
	...
	if (ret < 0)
		lcm_unprepare(panel);
	DISP_ERR("%s: ac264_p_7_a0014 poweroff Successful\n", __func__);
	return 0;
}
		...
		struct mtk_panel_params **ext_param, unsigned int id)
{
	...
	if (*ext_param)
		DISP_DEBUG("[LCM] ac264_p_7_a0014 data_rate:%d\n", (*ext_param)->data_rate);
	else
		DISP_ERR("[LCM] ac264_p_7_a0014 ext_param is NULL;\n");
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	pr_err("[LCM] %s+ ac264_p_7_a0014 Start\n", __func__);
	...
	register_device_proc("lcd", "AC264_A0014", "P_7");
...
/* #endif */ /* OPLUS_FEATURE_ONSCREENFINGERPRINT */
	...
	pr_err("ac264_p_7_a0014_dsi_cmd lcm probe End.\n");
	return ret;
}
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "ac264,p,7,a0014,cmd",
	},
	{}
};
...
MODULE_AUTHOR("oplus");
MODULE_DESCRIPTION("ac264,p,7,a0014,cmd,OLED Driver");
