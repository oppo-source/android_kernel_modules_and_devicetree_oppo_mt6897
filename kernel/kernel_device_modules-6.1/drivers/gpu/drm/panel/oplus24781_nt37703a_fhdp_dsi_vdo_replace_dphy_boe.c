...
#include "oplus24781_nt37703a_fhdp_dsi_vdo_replace_dphy_boe.h"
...
//-----------------------------------CMD3-----------------------------------
    ...
    lcm_dcs_write_seq_static(ctx,0xF8,0x01,0x8D);
    //VESAOSC=101.6MHz
    lcm_dcs_write_seq_static(ctx,0x6F,0x31);
    lcm_dcs_write_seq_static(ctx,0xF8,0x01,0x73);
...
//-----------------------------------CMD1-----------------------------------
    ...
    lcm_dcs_write_seq_static(ctx,0x88,0x01,0x02,0x1D,0x08,0x87,0x00,0x00,0x00,0x00);
    //res = 1080x2392
    ...
    lcm_dcs_write_seq_static(ctx,0x91,0xAB,0xA8,0x00,0x1A,0xC2,0x00,0x02,0x0E,0x02,0x7E,0x00,0x07,0x03,0xD8,0x03,0xEA,0x10,0xF0);
    //BC_CTRL
    lcm_dcs_write_seq_static(ctx,0x53,0x20);
    //VideoModeExt_VFP,VBPFSET0~2,IDLE
    lcm_dcs_write_seq_static(ctx,0x3B,0x00,0x38,0x00,0x48,0x00,0x38,0x03,0x90,0x00,0x38,0x0A,0x20,0x00,0x38,0x00,0x48);
    lcm_dcs_write_seq_static(ctx,0x6F,0x10);
    lcm_dcs_write_seq_static(ctx,0x3B,0x00,0x38,0x00,0x48);
    //FCON=01
...
static const struct of_device_id lcm_of_match[] = {
    { .compatible = "oplus24781,nt37703a,fhdp,dsi,vdo,replace,dphy,boe", },
    { }
};
...
static struct mipi_dsi_driver lcm_driver = {
    ...
    .remove = lcm_remove,
    .driver = {
        .name = "oplus24781_nt37703a_fhdp_dsi_vdo_replace_dphy_boe",
        .owner = THIS_MODULE,
