...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx,0x05,0x27);
	...
	lcm_dcs_write_seq_static(ctx,0x1C,0x1A);
	lcm_dcs_write_seq_static(ctx,0x1D,0x1B);
	lcm_dcs_write_seq_static(ctx,0x1E,0x1C);
	lcm_dcs_write_seq_static(ctx,0x1F,0x1D);
	lcm_dcs_write_seq_static(ctx,0x20,0x1F);
	lcm_dcs_write_seq_static(ctx,0x21,0x20);
	lcm_dcs_write_seq_static(ctx,0x22,0x24);
	lcm_dcs_write_seq_static(ctx,0x23,0x29);
	lcm_dcs_write_seq_static(ctx,0x24,0x2E);
	lcm_dcs_write_seq_static(ctx,0x25,0x32);
	lcm_dcs_write_seq_static(ctx,0x26,0x37);
	lcm_dcs_write_seq_static(ctx,0x27,0x3D);
	lcm_dcs_write_seq_static(ctx,0x28,0x3E);
	lcm_dcs_write_seq_static(ctx,0x29,0x10);
	lcm_dcs_write_seq_static(ctx,0x2A,0x28);
	lcm_dcs_write_seq_static(ctx,0x2B,0x3F);

	//UI MODE 55=01
	lcm_dcs_write_seq_static(ctx,0x30,0xE5);
	lcm_dcs_write_seq_static(ctx,0x31,0xE3);
	lcm_dcs_write_seq_static(ctx,0x32,0xDE);
	lcm_dcs_write_seq_static(ctx,0x33,0xD7);
	lcm_dcs_write_seq_static(ctx,0x34,0xD0);
	lcm_dcs_write_seq_static(ctx,0x35,0xC8);
	lcm_dcs_write_seq_static(ctx,0x36,0xC1);
	lcm_dcs_write_seq_static(ctx,0x37,0xBB);
	lcm_dcs_write_seq_static(ctx,0x38,0xB3);
	lcm_dcs_write_seq_static(ctx,0x39,0xAF);
	lcm_dcs_write_seq_static(ctx,0x3A,0xAC);
	lcm_dcs_write_seq_static(ctx,0x3B,0xA9);
	lcm_dcs_write_seq_static(ctx,0x3D,0xA5);
	lcm_dcs_write_seq_static(ctx,0x3F,0xA4);
	lcm_dcs_write_seq_static(ctx,0x40,0xA4);
	lcm_dcs_write_seq_static(ctx,0x41,0xA3);

	//STILL MODE 55=02 white%11
	lcm_dcs_write_seq_static(ctx,0x45,0xE5);
	lcm_dcs_write_seq_static(ctx,0x46,0xE3);
	lcm_dcs_write_seq_static(ctx,0x47,0xDE);
	lcm_dcs_write_seq_static(ctx,0x48,0xD7);
	lcm_dcs_write_seq_static(ctx,0x49,0xD0);
	lcm_dcs_write_seq_static(ctx,0x4A,0xC8);
	lcm_dcs_write_seq_static(ctx,0x4B,0xC1);
	...
	lcm_dcs_write_seq_static(ctx,0x52,0xA4);
	lcm_dcs_write_seq_static(ctx,0x53,0xA4);
	lcm_dcs_write_seq_static(ctx,0x54,0xA3);

	//MOVING MODE 55=03
	lcm_dcs_write_seq_static(ctx,0x58,0xE5);
	lcm_dcs_write_seq_static(ctx,0x59,0xE3);
	lcm_dcs_write_seq_static(ctx,0x5A,0xDE);
	lcm_dcs_write_seq_static(ctx,0x5B,0xD7);
	lcm_dcs_write_seq_static(ctx,0x5C,0xD0);
	lcm_dcs_write_seq_static(ctx,0x5D,0xC8);
	lcm_dcs_write_seq_static(ctx,0x5E,0xC1);
	lcm_dcs_write_seq_static(ctx,0x5F,0xBB);
	lcm_dcs_write_seq_static(ctx,0x60,0xB3);
	lcm_dcs_write_seq_static(ctx,0x61,0xAF);
	lcm_dcs_write_seq_static(ctx,0x62,0xAC);
	lcm_dcs_write_seq_static(ctx,0x63,0xA9);
	lcm_dcs_write_seq_static(ctx,0x64,0xA5);
	lcm_dcs_write_seq_static(ctx,0x65,0xA4);
	lcm_dcs_write_seq_static(ctx,0x66,0xA4);
	lcm_dcs_write_seq_static(ctx,0x67,0xA3);
	...
	lcm_dcs_write_seq_static(ctx,0x55,0x02);  /*CABC default mode*/
...
static const struct of_device_id lcm_of_match[] = {
	{
		.compatible = "ae150_p_d_a0038_vdo_pvt",
	},
	{}
};
