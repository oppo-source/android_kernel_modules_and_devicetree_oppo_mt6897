...
#if IS_ENABLED(CONFIG_DRM_PANEL_OPLUS24921_NT36532W_2800_2000_DUAL_DSI_VDO_144HZ) || IS_ENABLED(CONFIG_DRM_PANEL_X25N11_P_D_A0024_VDO_PANEL)
...
static int __maybe_unused led_set_virtual(struct mt_led_data *mdev,
		int brightness, unsigned int params, unsigned int params_flag)
{
	pr_info("set brightness %d ", brightness);
