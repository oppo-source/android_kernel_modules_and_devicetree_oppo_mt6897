...
struct mt6379_tcpc_data {
	...
	u16 did;
#ifdef OPLUS_FEATURE_CHG_BASIC
	struct mt6379_debug_data debug_data;
#endif /* OPLUS_FEATURE_CHG_BASIC */
	bool wd0_state;
	bool wd0_enable;
	bool vsc_status;
...
#ifdef OPLUS_FEATURE_CHG_BASIC
int tcpc_mt6379_reg_debug_msg_handler(struct tcpc_device *tcpc,
...
EXPORT_SYMBOL(tcpc_mt6379_reg_debug_msg_handler);

void tcpc_mt6379_unreg_debug_msg_handler(struct tcpc_device *tcpc)
{
	struct mt6379_tcpc_data *ddata;
...
EXPORT_SYMBOL(tcpc_mt6379_unreg_debug_msg_handler);
#endif /* OPLUS_FEATURE_CHG_BASIC */
