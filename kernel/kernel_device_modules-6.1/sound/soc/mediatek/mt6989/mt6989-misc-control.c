...
static const char *const mt6989_sgen_spktest_str[] = {
	"Off", "On"
};
...
static int mt6989_sgen_spktest_get(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	return 0;
}
...
static int mt6989_sgen_spktest_set(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_component *cmpnt = snd_soc_kcontrol_component(kcontrol);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(cmpnt);
...
static const struct soc_enum mt6989_afe_sgen_enum[] = {
	...
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6989_sgen_spktest_str),
				mt6989_sgen_spktest_str),
};
...
static const struct snd_kcontrol_new mt6989_afe_sgen_controls[] = {
	...
	SOC_ENUM_EXT("Audio_SineGen_spktest", mt6989_afe_sgen_enum[7],
		     mt6989_sgen_spktest_get, mt6989_sgen_spktest_set),
};
